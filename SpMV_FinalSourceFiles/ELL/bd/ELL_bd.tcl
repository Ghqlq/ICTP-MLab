...
proc create_root_design { parentCell } {
  ...
  # Create instance: spmv_ell_0, and set properties
  set spmv_ell_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:spmv_ell:1.0 spmv_ell_0 ]
...
\
  ...
  connect_bd_net -net comblock_0_fifo_afull_o [get_bd_pins comblock_0/fifo_afull_o] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins comblock_0/fifo_data_o] [get_bd_pins spmv_ell_0/in_fifo_TDATA]
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins comblock_0/fifo_valid_o] [get_bd_pins spmv_ell_0/in_fifo_TVALID]
  connect_bd_net -net comblock_0_reg0_o [get_bd_pins comblock_0/reg0_o] [get_bd_pins spmv_ell_0/ap_start]
  connect_bd_net -net rst_ps8_0_299M_peripheral_aresetn [get_bd_pins comblock_0/axil_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_299M/peripheral_aresetn] [get_bd_pins spmv_ell_0/ap_rst_n]
  connect_bd_net -net spmv_ell_0_in_fifo_TREADY [get_bd_pins comblock_0/fifo_re_i] [get_bd_pins spmv_ell_0/in_fifo_TREADY]
  connect_bd_net -net spmv_ell_0_out_fifo_TDATA [get_bd_pins comblock_0/fifo_data_i] [get_bd_pins spmv_ell_0/out_fifo_TDATA]
  connect_bd_net -net spmv_ell_0_out_fifo_TVALID [get_bd_pins comblock_0/fifo_we_i] [get_bd_pins spmv_ell_0/out_fifo_TVALID]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins spmv_ell_0/out_fifo_TREADY] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_299M/slowest_sync_clk] [get_bd_pins spmv_ell_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
